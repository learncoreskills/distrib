...
`,Yn=`# Day 2: a real dev setup, and a first version kids can actually use
...
`,Xn=`# Day 3: a smarter daily practice, and a window into how it all works
...
`,Zn=`# Day 4: a chart that shows a child's whole learning at a glance 
...
`,$n=`# blog
blog
`,er=200;function tr(e){let t=e.replace(/^#\s+.+$/m,``).split(/\n\s*\n/).map(e=>e.trim()).find(e=>e.length>0);if(t===void 0)return``;let n=t.replace(/\s+/g,` `).trim();if(n.length<=er)return n;let r=n.slice(0,er),i=r.lastIndexOf(` `);return`${r.slice(0,i>0?i:er)}…`}function nr(e,t){return/^#\s+(.+)$/m.exec(e)?.[1]?.trim()??t}var rr=Object.assign({"../../../../../blog/2026-09-12-kicking-off-the-project.md":Jn,"../../../../../blog/2026-09-13-dev-environment-and-v1.md":Yn,"../../../../../blog/2026-09-14-daily-practice-and-docs.md":Xn,"../../../../../blog/2026-09-15-a-chart-that-shows-the-whole-picture.md":Zn,"../../../../../blog/CLAUDE.md":Qn,"../../../../../blog/README.md":$n});function ir(){let e=[];for(let[t,n]of Object.entries(rr)){let r=qn(t.split(`/`).pop()??t);r!==null&&e.push({id:r.id,date:r.date,title:nr(n,r.id),summary:tr(n),content:n})}return e.sort((e,t)=>t.date.localeCompare(e.date))}var ar=`# Mathematics Curriculum (MVP)
...
`,or=`# The Primary Skills Framework
...
* ADR-0004 (Testing & Quality Gates)
`,dr=`# ADR-0003: Client/Server Split, Repo Topology & Hosting
...
`,fr=`# ADR-0004: Testing & Quality Gates
...
`,pr=`# ADR-0005: Client/Server Responsibility Boundary & API Contract
...
`,mr=`# ADR-0006: Client-Only Architecture for V1
...
* \`.specify/memory/constitution.md\` Principle IV (Local-First Privacy) — amendment accompanying
  this ADR
`,hr=`# ADR-0007: Frontend Framework — React over Angular
...
* ADR-0006 (Client-Only Architecture for V1) — package layout unaffected; \`apps/web\`'s framework
  updated.
`,gr=Object.assign({"../../../../../specs/docs/product/CURRICULUM.md":ar,"../../../../../specs/docs/product/PRIMARY-SKILLS-FRAMEWORK.md":or,"../../../../../specs/docs/product/vision.md":sr}),_r=Object.assign({"../../../../../specs/docs/architecture/ARCHITECTURE.md":cr}),vr=Object.assign({"../../../../../specs/docs/architecture/decisions/0001-frontend-stack.md":lr,"../../../../../specs/docs/architecture/decisions/0002-backend-stack.md":ur,"../../../../../specs/docs/architecture/decisions/0003-client-server-split-and-hosting.md":dr,"../../../../../specs/docs/architecture/decisions/0004-testing-and-quality-gates.md":fr,"../../../../../specs/docs/architecture/decisions/0005-client-server-responsibility-boundary.md":pr,"../../../../../specs/docs/architecture/decisions/0006-client-only-architecture.md":mr,"../../../../../specs/docs/architecture/decisions/0007-frontend-framework-react.md":hr});function yr(e,t){return`${t}-${(e.split(`/`).pop()??e).replace(/\.md$/,``).toLowerCase()}`}function br(e,t){return Object.entries(e).map(([e,n])=>{let r=yr(e,t);return{id:r,title:nr(n,r),category:t,content:n}})}function xr(){return[...br(gr,`product`),...br(_r,`architecture`),...br(vr,`architecture`)]}var Sr=`# Feature Specification: Competency Model
...
- \`specs/004-exercise-plugin-engine/spec.md\`
`,Cr=`# Feature Specification: Mental Addition Exercise (First Exercise Plugin)
...
- \`specs/003-mastery-engine/spec.md\`
- \`specs/004-exercise-plugin-engine/spec.md\`
`,wr=`# Feature Specification: Mastery Engine
...
`,Tr=`# Feature Specification: Exercise Plugin Engine
...
`,Er=`# Feature Specification: Daily Practice
...
- \`specs/003-mastery-engine/spec.md\`
- \`specs/004-exercise-plugin-engine/spec.md\`
`,Dr=`# Feature Specification: Accounts, Multiple Children & Privacy
...
`,Or=`# Feature Specification: Printable Worksheets
...
- \`specs/003-mastery-engine/spec.md\`
- \`specs/008-teacher-mode/spec.md\`
`,kr=`# Feature Specification: Teacher Mode (One-Shot Classroom Sessions)
...
`,Ar=`# Feature Specification: V1 App Shell (Practice Loop Integration)
...
`,jr=`# Feature Specification: Documentation & Blog
...
- Reaching the documentation/blog area before the child-profile gate (FR-011) means the app's
  ...
  sees.
`,Mr=`# Feature Specification: Parent Area — Advancement Report & Data Export/Import
...
- \`docs/product/vision.md\` — "Look & feel" section, for the parent-facing calm/professional visual
  intent.
`,Nr=`# Feature Specification: Progression Radar Chart
...
`,...c.current()}))),s(),e.title&&(s=n.enter(`title${a}`),l+=c.move(` `+i),l+=c.move(n.safe(e.title,{before:l,after:i,...c.current()})),l+=c.move(i),s()),o(),l}function Md(e){let t=e.options.emphasis||`*`;if(t!==`*`&&t!==`_`)throw Error("Cannot serialize emphasis with `"+t+"` for `options.emphasis`, expected `*`, or `_`");return t}function Nd(e){return`&#x`+e.toString(16).toUpperCase()+`;`}function Pd(e,t,n){let r=ao(e),i=ao(t);return r===void 0?i===void 0?n===`_`?{inside:!0,outside:!0}:{inside:!1,outside:!1}:i===1?{inside:!0,outside:!0}:{inside:!1,outside:!0}:r===1?i===void 0?{inside:!1,outside:!1}:i===1?{inside:!0,outside:!0}:{inside:!1,outside:!1}:i===void 0?{inside:!1,outside:!1}:i===1?{inside:!0,outside:!1}:{inside:!1,outside:!1}}Fd.peek=Id;function Fd(e,t,n,r){let i=Md(n),a=n.enter(`emphasis`),o=n.createTracker(r),s=o.move(i),c=o.move(n.containerPhrasing(e,{after:i,before:s,...o.current()})),l=c.charCodeAt(0),u=Pd(r.before.charCodeAt(r.before.length-1),l,i);u.inside&&(c=Nd(l)+c.slice(1));let d=c.charCodeAt(c.length-1),f=Pd(r.after.charCodeAt(0),d,i);f.inside&&(c=c.slice(0,-1)+Nd(d));let p=o.move(i);return a(),n.attentionEncodeSurroundingInfo={after:f.outside,before:u.outside},s+c+p}function Id(e,t,n){return n.options.emphasis||`*`}function Ld(e,t){let n=!1;return Al(e,function(e){if(`value`in e&&/\r?\n|\r/.test(e.value)||e.type===`break`)return n=!0,!1}),!!((!e.depth||e.depth<3)&&Oa(e)&&(t.options.setext||n))}function Rd(e,t,n,r){let i=Math.max(Math.min(6,e.depth||1),1),a=n.createTracker(r);if(Ld(e,n)){let t=n.enter(`headingSetext`),r=n.enter(`phrasing`),o=n.containerPhrasing(e,{...a.current(),before:`
`,after:`
`});return r(),t(),o+`
`+(i===1?`=`:`-`).repeat(o.length-(Math.max(o.lastIndexOf(`\r`),o.lastIndexOf(`
`))+1))}let o=`#`.repeat(i),s=n.enter(`headingAtx`),c=n.enter(`phrasing`);a.move(o+` `);let l=n.containerPhrasing(e,{before:`# `,after:`
`,...a.current()});return/^[\t ]/.test(l)&&(l=Nd(l.charCodeAt(0))+l.slice(1)),l=l?o+` `+l:o,n.options.closeAtx&&(l+=` `+o),c(),s(),l}zd.peek=Bd;function zd(e){return e.value||``}function Bd(){return`<`}Vd.peek=Hd;function Vd(e,t,n,r){let i=Ad(n),a=i===`"`?`Quote`:`Apostrophe`,o=n.enter(`image`),s=n.enter(`label`),c=n.createTracker(r),l=c.move(`![`);return l+=c.move(n.safe(e.alt,{before:l,after:`]`,...c.current()})),l+=c.move(`](`),s(),!e.url&&e.title||/[\0- \u007F]/.test(e.url)?(s=n.enter(`destinationLiteral`),l+=c.move(`<`),l+=c.move(n.safe(e.url,{before:l,after:`>`,...c.current()})),l+=c.move(`>`)):(s=n.enter(`destinationRaw`),l+=c.move(n.safe(e.url,{before:l,after:e.title?` `:`)`,...c.current()}))),s(),e.title&&(s=n.enter(`title${a}`),l+=c.move(` `+i),l+=c.move(n.safe(e.title,{before:l,after:i,...c.current()})),l+=c.move(i),s()),l+=c.move(`)`),o(),l}function Hd(){return`!`}Ud.peek=Wd;function Ud(e,t,n,r){let i=e.referenceType,a=n.enter(`imageReference`),o=n.enter(`label`),s=n.createTracker(r),c=s.move(`![`),l=n.safe(e.alt,{before:c,after:`]`,...s.current()});c+=s.move(l+`][`),o();let u=n.stack;n.stack=[],o=n.enter(`reference`);let d=n.safe(n.associationId(e),{before:c,after:`]`,...s.current()});return o(),n.stack=u,a(),i===`full`||!l||l!==d?c+=s.move(d+`]`):i===`shortcut`?c=c.slice(0,-1):c+=s.move(`]`),c}function Wd(){return`!`}Gd.peek=Kd;function Gd(e,t,n){let r=e.value||``,i="`",a=-1;for(;RegExp("(^|[^`])"+i+"([^`]|$)").test(r);)i+="`";for(/[^ \r\n]/.test(r)&&(/^[ \r\n]/.test(r)&&/[ \r\n]$/.test(r)||/^`|`$/.test(r))&&(r=` `+r+` `);++a<n.unsafe.length;){let e=n.unsafe[a],t=n.compilePattern(e),i;if(e.atBreak)for(;i=t.exec(r);){let e=i.index;r.charCodeAt(e)===10&&r.charCodeAt(e-1)===13&&e--,r=r.slice(0,e)+` `+r.slice(i.index+1)}}return i+r+i}function Kd(){return"`"}function qd(e,t){let n=Oa(e);return!(t.options.resourceLink||!e.url||e.title||!e.children||e.children.length!==1||e.children[0].type!==`text`||n!==e.url&&`mailto:`+n!==e.url||!/^[a-z][a-z+.-]+:/i.test(e.url)||/[\0- <>\u007F]/.test(e.url))}Jd.peek=Yd;function Jd(e,t,n,r){let i=Ad(n),a=i===`"`?`Quote`:`Apostrophe`,o=n.createTracker(r),s,c;if(qd(e,n)){let t=n.stack;n.stack=[],s=n.enter(`autolink`);let r=o.move(`<`);return r+=o.move(n.containerPhrasing(e,{before:r,after:`>`,...o.current()})),r+=o.move(`>`),s(),n.stack=t,r}s=n.enter(`link`),c=n.enter(`label`);let l=o.move(`[`);return l+=o.move(n.containerPhrasing(e,{before:l,after:`](`,...o.current()})),l+=o.move(`](`),c(),!e.url&&e.title||/[\0- \u007F]/.test(e.url)?(c=n.enter(`destinationLiteral`),l+=o.move(`<`),l+=o.move(n.safe(e.url,{before:l,after:`>`,...o.current()})),l+=o.move(`>`)):(c=n.enter(`destinationRaw`),l+=o.move(n.safe(e.url,{before:l,after:e.title?` `:`)`,...o.current()}))),c(),e.title&&(c=n.enter(`title${a}`),l+=o.move(` `+i),l+=o.move(n.safe(e.title,{before:l,after:i,...o.current()})),l+=o.move(i),c()),l+=o.move(`)`),s(),l}function Yd(e,t,n){return qd(e,n)?`<`:`[`}Xd.peek=Zd;function Xd(e,t,n,r){let i=e.referenceType,a=n.enter(`linkReference`),o=n.enter(`label`),s=n.createTracker(r),c=s.move(`[`),l=n.containerPhrasing(e,{before:c,after:`]`,...s.current()});c+=s.move(l+`][`),o();let u=n.stack;n.stack=[],o=n.enter(`reference`);let d=n.safe(n.associationId(e),{before:c,after:`]`,...s.current()});return o(),n.stack=u,a(),i===`full`||!l||l!==d?c+=s.move(d+`]`):i===`shortcut`?c=c.slice(0,-1):c+=s.move(`]`),c}function Zd(){return`[`}function Qd(e){let t=e.options.bullet||`*`;if(t!==`*`&&t!==`+`&&t!==`-`)throw Error("Cannot serialize items with `"+t+"` for `options.bullet`, expected `*`, `+`, or `-`");return t}function $d(e){let t=Qd(e),n=e.options.bulletOther;if(!n)return t===`*`?`-`:`*`;if(n!==`*`&&n!==`+`&&n!==`-`)throw Error("Cannot serialize items with `"+n+"` for `options.bulletOther`, expected `*`, `+`, or `-`");if(n===t)throw Error("Expected `bullet` (`"+t+"`) and `bulletOther` (`"+n+"`) to be different");return n}function ef(e){let t=e.options.bulletOrdered||`.`;if(t!==`.`&&t!==`)`)throw Error("Cannot serialize items with `"+t+"` for `options.bulletOrdered`, expected `.` or `)`");return t}function tf(e){let t=e.options.rule||`*`;if(t!==`*`&&t!==`-`&&t!==`_`)throw Error("Cannot serialize rules with `"+t+"` for `options.rule`, expected `*`, `-`, or `_`");return t}function nf(e,t,n,r){let i=n.enter(`list`),a=n.bulletCurrent,o=e.ordered?ef(n):Qd(n),s=e.ordered?o===`.`?`)`:`.`:$d(n),c=t&&n.bulletLastUsed?o===n.bulletLastUsed:!1;if(!e.ordered){let t=e.children?e.children[0]:void 0;if((o===`*`||o===`-`)&&t&&(!t.children||!t.children[0])&&n.stack[n.stack.length-1]===`list`&&n.stack[n.stack.length-2]===`listItem`&&n.stack[n.stack.length-3]===`list`&&n.stack[n.stack.length-4]===`listItem`&&n.indexStack[n.indexStack.length-1]===0&&n.indexStack[n.indexStack.length-2]===0&&n.indexStack[n.indexStack.length-3]===0&&(c=!0),tf(n)===o&&t){let t=-1;for(;++t<e.children.length;){let n=e.children[t];if(n&&n.type===`listItem`&&n.children&&n.children[0]&&n.children[0].type===`thematicBreak`){c=!0;break}}}}c&&(o=s),n.bulletCurrent=o;let l=n.containerFlow(e,r);return n.bulletLastUsed=o,n.bulletCurrent=a,i(),l}function rf(e){let t=e.options.listItemIndent||`one`;if(t!==`tab`&&t!==`one`&&t!==`mixed`)throw Error("Cannot serialize items with `"+t+"` for `options.listItemIndent`, expected `tab`, `one`, or `mixed`");return t}function af(e,t,n,r){let i=rf(n),a=n.bulletCurrent||Qd(n);t&&t.type===`list`&&t.ordered&&(a=(typeof t.start==`number`&&t.start>-1?t.start:1)+(n.options.incrementListMarker===!1?0:t.children.indexOf(e))+a);let o=a.length+1;(i===`tab`||i===`mixed`&&(t&&t.type===`list`&&t.spread||e.spread))&&(o=Math.ceil(o/4)*4);let s=n.createTracker(r);s.move(a+` `.repeat(o-a.length)),s.shift(o);let c=n.enter(`listItem`),l=n.indentLines(n.containerFlow(e,s.current()),u);return c(),l;function u(e,t,n){return t?(n?``:` `.repeat(o))+e:(n?a:a+` `.repeat(o-a.length))+e}}function of(e,t,n,r){let i=n.enter(`paragraph`),a=n.enter(`phrasing`),o=n.containerPhrasing(e,r);return a(),i(),o}var sf=yl([`break`,`delete`,`emphasis`,`footnote`,`footnoteReference`,`image`,`imageReference`,`inlineCode`,`inlineMath`,`link`,`linkReference`,`mdxJsxTextElement`,`mdxTextExpression`,`strong`,`text`,`textDirective`]);function cf(e,t,n,r){return(e.children.some(function(e){return sf(e)})?n.containerPhrasing:n.containerFlow).call(n,e,r)}function lf(e){let t=e.options.strong||`*`;if(t!==`*`&&t!==`_`)throw Error("Cannot serialize strong with `"+t+"` for `options.strong`, expected `*`, or `_`");return t}uf.peek=df;function uf(e,t,n,r){let i=lf(n),a=n.enter(`strong`),o=n.createTracker(r),s=o.move(i+i),c=o.move(n.containerPhrasing(e,{after:i,before:s,...o.current()})),l=c.charCodeAt(0),u=Pd(r.before.charCodeAt(r.before.length-1),l,i);u.inside&&(c=Nd(l)+c.slice(1));let d=c.charCodeAt(c.length-1),f=Pd(r.after.charCodeAt(0),d,i);f.inside&&(c=c.slice(0,-1)+Nd(d));let p=o.move(i+i);return a(),n.attentionEncodeSurroundingInfo={after:f.outside,before:u.outside},s+c+p}function df(e,t,n){return n.options.strong||`*`}function ff(e,t,n,r){return n.safe(e.value,r)}function pf(e){let t=e.options.ruleRepetition||3;if(t<3)throw Error("Cannot serialize rules with repetition `"+t+"` for `options.ruleRepetition`, expected `3` or more");return t}function Z(e,t,n){let r=(tf(n)+(n.options.ruleSpaces?` `:``)).repeat(pf(n));return n.options.ruleSpaces?r.slice(0,-1):r}var mf={blockquote:bd,break:wd,code:Od,definition:jd,emphasis:Fd,hardBreak:wd,heading:Rd,html:zd,image:Vd,imageReference:Ud,inlineCode:Gd,link:Jd,linkReference:Xd,list:nf,listItem:af,paragraph:of,root:cf,strong:uf,text:ff,thematicBreak:Z};function hf(){return{enter:{table:gf,tableData:bf,tableHeader:bf,tableRow:vf},exit:{codeText:xf,table:_f,tableData:yf,tableHeader:yf,tableRow:yf}}}function gf(e){let t=e._align;this.enter({type:`table`,align:t.map(function(e){return e===`none`?null:e}),children:[]},e),this.data.inTable=!0}function _f(e){this.exit(e),this.data.inTable=void 0}function vf(e){this.enter({type:`tableRow`,children:[]},e)}function yf(e){this.exit(e)}function bf(e){this.enter({type:`tableCell`,children:[]},e)}function xf(e){let t=this.resume();this.data.inTable&&(t=t.replace(/\\([\\|])/g,Sf));let n=this.stack[this.stack.length-1];n.type,n.value=t,this.exit(e)}function Sf(e,t){return t===`|`?t:e}function Cf(e){let t=e||{},n=t.tableCellPadding,r=t.tablePipeAlign,i=t.stringLength,a=n?` `:`|`;return{unsafe:[{character:`\r`,inConstruct:`tableCell`},{character:`
`,inConstruct:`tableCell`},{atBreak:!0,character:`|`,after:`[	 :-]`},{character:`|`,inConstruct:`tableCell`},{atBreak:!0,character:`:`,after:`-`},{atBreak:!0,character:`-`,after:`[:|-]`}],handlers:{inlineCode:f,table:o,tableCell:c,tableRow:s}};function o(e,t,n,r){return l(u(e,n,r),e.align)}function s(e,t,n,r){let i=l([d(e,n,r)]);return i.slice(0,i.indexOf(`
`))}function c(e,t,n,r){let i=n.enter(`tableCell`),o=n.enter(`phrasing`),s=n.containerPhrasing(e,{...r,before:a,after:a});return o(),i(),s}function l(e,t){return _d(e,{align:t,alignDelimiters:r,padding:n,stringLength:i})}function u(e,t,n){let r=e.children,i=-1,a=[],o=t.enter(`table`);for(;++i<r.length;)a[i]=d(r[i],t,n);return o(),a}function d(e,t,n){let r=e.children,i=-1,a=[],o=t.enter(`tableRow`);for(;++i<r.length;)a[i]=c(r[i],e,t,n);return o(),a}function f(e,t,n){let r=mf.inlineCode(e,t,n);return n.stack.includes(`tableCell`)&&(r=r.replace(/\|/g,`\\$&`)),r}}function wf(){return{exit:{taskListCheckValueChecked:Ef,taskListCheckValueUnchecked:Ef,paragraph:Df}}}function Tf(){return{unsafe:[{atBreak:!0,character:`-`,after:`[:|-]`}],handlers:{listItem:Of}}}function Ef(e){let t=this.stack[this.stack.length-2];t.type,t.checked=e.type===`taskListCheckValueChecked`}function Df(e){let t=this.stack[this.stack.length-2];if(t&&t.type===`listItem`&&typeof t.checked==`boolean`){let e=this.stack[this.stack.length-1];e.type;let n=e.children[0];if(n&&n.type===`text`){let r=t.children,i=-1,a;for(;++i<r.length;){let e=r[i];if(e.type===`paragraph`){a=e;break}}a===e&&(n.value=n.value.slice(1),n.value.length===0?e.children.shift():e.position&&n.position&&typeof n.position.start.offset==`number`&&(n.position.start.column++,n.position.start.offset++,e.position.start=Object.assign({},n.position.start)))}}this.exit(e)}function Of(e,t,n,r){let i=e.children[0],a=typeof e.checked==`boolean`&&i&&i.type===`paragraph`,o=`[`+(e.checked?`x`:` `)+`] `,s=n.createTracker(r);a&&s.move(o);let c=mf.listItem(e,t,n,{...r,...s.current()});return a&&(c=c.replace(/^(?:[*+-]|\d+\.)([\r\n]| {1,3})/,l)),c;function l(e){return e+o}}function kf(){return[Bu(),ad(),ud(),hf(),wf()]}function Af(e){return{extensions:[Vu(),od(e),dd(),Cf(e),Tf()]}}var jf={tokenize:Wf,partial:!0},Mf={tokenize:Gf,partial:!0},Nf={tokenize:Kf,partial:!0},Pf={tokenize:qf,partial:!0},Ff={tokenize:Jf,partial:!0},If={name:`wwwAutolink`,tokenize:Hf,previous:Yf},Lf={name:`protocolAutolink`,tokenize:Uf,previous:Xf},Rf={name:`emailAutolink`,tokenize:Q,previous:Zf},zf={};function Bf(){return{text:zf}}for(var Vf=48;Vf<123;)zf[Vf]=Rf,Vf++,Vf===58?Vf=65:Vf===91&&(Vf=97);zf[43]=Rf,zf[45]=Rf,zf[46]=Rf,zf[95]=Rf,zf[72]=[Rf,Lf],zf[104]=[Rf,Lf],zf[87]=[Rf,If],zf[119]=[Rf,If];function Q(e,t,n){let r=this,i,a;return o;function o(t){return!Qf(t)||!Zf.call(r,r.previous)||$f(r.events)?n(t):(e.enter(`literalAutolink`),e.enter(`literalAutolinkEmail`),s(t))}function s(t){return Qf(t)?(e.consume(t),s):t===64?(e.consume(t),c):n(t)}function c(t){return t===46?e.check(Ff,u,l)(t):t===45||t===95||Ua(t)?(a=!0,e.consume(t),c):u(t)}function l(t){return e.consume(t),i=!0,c}function u(o){return a&&i&&Ha(r.previous)?(e.exit(`literalAutolinkEmail`),e.exit(`literalAutolink`),t(o)):n(o)}}function Hf(e,t,n){let r=this;return i;function i(t){return t!==87&&t!==119||!Yf.call(r,r.previous)||$f(r.events)?n(t):(e.enter(`literalAutolink`),e.enter(`literalAutolinkWww`),e.check(jf,e.attempt(Mf,e.attempt(Nf,a),n),n)(t))}function a(n){return e.exit(`literalAutolinkWww`),e.exit(`literalAutolink`),t(n)}}function Uf(e,t,n){let r=this,i=``,a=!1;return o;function o(t){return(t===72||t===104)&&Xf.call(r,r.previous)&&!$f(r.events)?(e.enter(`literalAutolink`),e.enter(`literalAutolinkHttp`),i+=String.fromCodePoint(t),e.consume(t),s):n(t)}function s(t){if(Ha(t)&&i.length<5)return i+=String.fromCodePoint(t),e.consume(t),s;if(t===58){let n=i.toLowerCase();if(n===`http`||n===`https`)return e.consume(t),c}return n(t)}function c(t){return t===47?(e.consume(t),a?l:(a=!0,c)):n(t)}function l(t){return t===null||Ga(t)||B(t)||Xa(t)||Ya(t)?n(t):e.attempt(Mf,e.attempt(Nf,u),n)(t)}function u(n){return e.exit(`literalAutolinkHttp`),e.exit(`literalAutolink`),t(n)}}function Wf(e,t,n){let r=0;return i;function i(t){return(t===87||t===119)&&r<3?(r++,e.consume(t),i):t===46&&r===3?(e.consume(t),a):n(t)}function a(e){return e===null?n(e):t(e)}}function Gf(e,t,n){let r,i,a;return o;function o(t){return t===46||t===95?e.check(Pf,c,s)(t):t===null||B(t)||Xa(t)||t!==45&&Ya(t)?c(t):(a=!0,e.consume(t),o)}function s(t){return t===95?r=!0:(i=r,r=void 0),e.consume(t),o}function c(e){return i||r||!a?n(e):t(e)}}function Kf(e,t){let n=0,r=0;return i;function i(o){return o===40?(n++,e.consume(o),i):o===41&&r<n?a(o):o===33||o===34||o===38||o===39||o===41||o===42||o===44||o===46||o===58||o===59||o===60||o===63||o===93||o===95||o===126?e.check(Pf,t,a)(o):o===null||B(o)||Xa(o)?t(o):(e.consume(o),i)}function a(t){return t===41&&r++,e.consume(t),i}}function qf(e,t,n){return r;function r(o){return o===33||o===34||o===39||o===41||o===42||o===44||o===46||o===58||o===59||o===63||o===95||o===126?(e.consume(o),r):o===38?(e.consume(o),a):o===93?(e.consume(o),i):o===60||o===null||B(o)||Xa(o)?t(o):n(o)}function i(e){return e===null||e===40||e===91||B(e)||Xa(e)?t(e):r(e)}function a(e){return Ha(e)?o(e):n(e)}function o(t){return t===59?(e.consume(t),r):Ha(t)?(e.consume(t),o):n(t)}}function Jf(e,t,n){return r;function r(t){return e.consume(t),i}function i(e){return Ua(e)?n(e):t(e)}}function Yf(e){return e===null||e===40||e===42||e===95||e===91||e===93||e===126||B(e)}function Xf(e){return!Ha(e)}function Zf(e){return!(e===47||Qf(e))}function Qf(e){return e===43||e===45||e===46||e===95||Ua(e)}function $f(e){let t=e.length,n=!1;for(;t--;){let r=e[t][1];if((r.type===`labelLink`||r.type===`labelImage`)&&!r._balanced){n=!0;break}if(r._gfmAutolinkLiteralWalkedInto){n=!1;break}}return e.length>0&&!n&&(e[e.length-1][1]._gfmAutolinkLiteralWalkedInto=!0),n}var ep={tokenize:sp,partial:!0};function $(){return{document:{91:{name:`gfmFootnoteDefinition`,tokenize:ip,continuation:{tokenize:ap},exit:op}},text:{91:{name:`gfmFootnoteCall`,tokenize:rp},93:{name:`gfmPotentialFootnoteCall`,add:`after`,tokenize:tp,resolveTo:np}}}}function tp(e,t,n){let r=this,i=r.events.length,a=r.parser.gfmFootnotes||(r.parser.gfmFootnotes=[]),o;for(;i--;){let e=r.events[i][1];if(e.type===`labelImage`){o=e;break}if(e.type===`gfmFootnoteCall`||e.type===`labelLink`||e.type===`label`||e.type===`image`||e.type===`link`)break}return s;function s(i){if(!o||!o._balanced)return n(i);let s=Va(r.sliceSerialize({start:o.end,end:r.now()}));return s.codePointAt(0)!==94||!a.includes(s.slice(1))?n(i):(e.enter(`gfmFootnoteCallLabelMarker`),e.consume(i),e.exit(`gfmFootnoteCallLabelMarker`),t(i))}}function np(e,t){let n=e.length;for(;n--;)if(e[n][1].type===`labelImage`&&e[n][0]===`enter`){e[n][1];break}e[n+1][1].type=`data`,e[n+3][1].type=`gfmFootnoteCallLabelMarker`;let r={type:`gfmFootnoteCall`,start:Object.assign({},e[n+3][1].start),end:Object.assign({},e[e.length-1][1].end)},i={type:`gfmFootnoteCallMarker`,start:Object.assign({},e[n+3][1].end),end:Object.assign({},e[n+3][1].end)};i.end.column++,i.end.offset++,i.end._bufferIndex++;let a={type:`gfmFootnoteCallString`,start:Object.assign({},i.end),end:Object.assign({},e[e.length-1][1].start)},o={type:`chunkString`,contentType:`string`,start:Object.assign({},a.start),end:Object.assign({},a.end)},s=[e[n+1],e[n+2],[`enter`,r,t],e[n+3],e[n+4],[`enter`,i,t],[`exit`,i,t],[`enter`,a,t],[`enter`,o,t],[`exit`,o,t],[`exit`,a,t],e[e.length-2],e[e.length-1],[`exit`,r,t]];return e.splice(n,e.length-n+1,...s),e}function rp(e,t,n){let r=this,i=r.parser.gfmFootnotes||(r.parser.gfmFootnotes=[]),a=0,o;return s;function s(t){return e.enter(`gfmFootnoteCall`),e.enter(`gfmFootnoteCallLabelMarker`),e.consume(t),e.exit(`gfmFootnoteCallLabelMarker`),c}function c(t){return t===94?(e.enter(`gfmFootnoteCallMarker`),e.consume(t),e.exit(`gfmFootnoteCallMarker`),e.enter(`gfmFootnoteCallString`),e.enter(`chunkString`).contentType=`string`,l):n(t)}function l(s){if(a>999||s===93&&!o||s===null||s===91||B(s))return n(s);if(s===93){e.exit(`chunkString`);let a=e.exit(`gfmFootnoteCallString`);return i.includes(Va(r.sliceSerialize(a)))?(e.enter(`gfmFootnoteCallLabelMarker`),e.consume(s),e.exit(`gfmFootnoteCallLabelMarker`),e.exit(`gfmFootnoteCall`),t):n(s)}return B(s)||(o=!0),a++,e.consume(s),s===92?u:l}function u(t){return t===91||t===92||t===93?(e.consume(t),a++,l):l(t)}}function ip(e,t,n){let r=this,i=r.parser.gfmFootnotes||(r.parser.gfmFootnotes=[]),a,o=0,s;return c;function c(t){return e.enter(`gfmFootnoteDefinition`)._container=!0,e.enter(`gfmFootnoteDefinitionLabel`),e.enter(`gfmFootnoteDefinitionLabelMarker`),e.consume(t),e.exit(`gfmFootnoteDefinitionLabelMarker`),l}function l(t){return t===94?(e.enter(`gfmFootnoteDefinitionMarker`),e.consume(t),e.exit(`gfmFootnoteDefinitionMarker`),e.enter(`gfmFootnoteDefinitionLabelString`),e.enter(`chunkString`).contentType=`string`,u):n(t)}function u(t){if(o>999||t===93&&!s||t===null||t===91||B(t))return n(t);if(t===93){e.exit(`chunkString`);let n=e.exit(`gfmFootnoteDefinitionLabelString`);return a=Va(r.sliceSerialize(n)),e.enter(`gfmFootnoteDefinitionLabelMarker`),e.consume(t),e.exit(`gfmFootnoteDefinitionLabelMarker`),e.exit(`gfmFootnoteDefinitionLabel`),f}return B(t)||(s=!0),o++,e.consume(t),t===92?d:u}function d(t){return t===91||t===92||t===93?(e.consume(t),o++,u):u(t)}function f(t){return t===58?(e.enter(`definitionMarker`),e.consume(t),e.exit(`definitionMarker`),i.includes(a)||i.push(a),H(e,p,`gfmFootnoteDefinitionWhitespace`)):n(t)}function p(e){return t(e)}}function ap(e,t,n){return e.check(mo,t,e.attempt(ep,t,n))}function op(e){e.exit(`gfmFootnoteDefinition`)}function sp(e,t,n){let r=this;return H(e,i,`gfmFootnoteDefinitionIndent`,5);function i(e){let i=r.events[r.events.length-1];return i&&i[1].type===`gfmFootnoteDefinitionIndent`&&i[2].sliceSerialize(i[1],!0).length===4?t(e):n(e)}}function cp(e){let t=(e||{}).singleTilde,n={name:`strikethrough`,tokenize:i,resolveAll:r};return t??=!0,{text:{126:n},insideSpan:{null:[n]},attentionMarkers:{null:[126]}};function r(e,t){let n=-1;for(;++n<e.length;)if(e[n][0]===`enter`&&e[n][1].type===`strikethroughSequenceTemporary`&&e[n][1]._close){let r=n;for(;r--;)if(e[r][0]===`exit`&&e[r][1].type===`strikethroughSequenceTemporary`&&e[r][1]._open&&e[n][1].end.offset-e[n][1].start.offset===e[r][1].end.offset-e[r][1].start.offset){e[n][1].type=`strikethroughSequence`,e[r][1].type=`strikethroughSequence`;let i={type:`strikethrough`,start:Object.assign({},e[r][1].start),end:Object.assign({},e[n][1].end)},a={type:`strikethroughText`,start:Object.assign({},e[r][1].end),end:Object.assign({},e[n][1].start)},o=[[`enter`,i,t],[`enter`,e[r][1],t],[`exit`,e[r][1],t],[`enter`,a,t]],s=t.parser.constructs.insideSpan.null;s&&Pa(o,o.length,0,oo(s,e.slice(r+1,n),t)),Pa(o,o.length,0,[[`exit`,a,t],[`enter`,e[n][1],t],[`exit`,e[n][1],t],[`exit`,i,t]]),Pa(e,r-1,n-r+3,o),n=r+o.length-2;break}}for(n=-1;++n<e.length;)e[n][1].type===`strikethroughSequenceTemporary`&&(e[n][1].type=`data`);return e}function i(e,n,r){let i=this.previous,a=this.events,o=0;return s;function s(t){return i===126&&a[a.length-1][1].type!==`characterEscape`?r(t):(e.enter(`strikethroughSequenceTemporary`),c(t))}function c(a){let s=ao(i);if(a===126)return o>1?r(a):(e.consume(a),o++,c);if(o<2&&!t)return r(a);let l=e.exit(`strikethroughSequenceTemporary`),u=ao(a);return l._open=!u||u===2&&!!s,l._close=!s||s===2&&!!u,n(a)}}}var lp=class{constructor(){this.map=[],this.index=new Map}add(e,t,n){up(this,e,t,n)}consume(e){if(this.map.sort(function(e,t){return e[0]-t[0]}),this.map.length===0)return;let t=this.map.length,n=[];for(;t>0;)--t,n.push(e.slice(this.map[t][0]+this.map[t][1]),this.map[t][2]),e.length=this.map[t][0];n.push(e.slice()),e.length=0;let r=n.pop();for(;r;){for(let t of r)e.push(t);r=n.pop()}this.map.length=0,this.index.clear()}};function up(e,t,n,r){if(n===0&&r.length===0)return;let i=e.index.get(t);if(i){i[1]+=n,i[2].push(...r);return}let a=[t,n,r];e.map.push(a),e.index.set(t,a)}function dp(e,t){let n=!1,r=[];for(;t<e.length;){let i=e[t];if(n){if(i[0]===`enter`)i[1].type===`tableContent`&&r.push(e[t+1][1].type===`tableDelimiterMarker`?`left`:`none`);else if(i[1].type===`tableContent`){if(e[t-1][1].type===`tableDelimiterMarker`){let e=r.length-1;r[e]=r[e]===`left`?`center`:`right`}}else if(i[1].type===`tableDelimiterRow`)break}else i[0]===`enter`&&i[1].type===`tableDelimiterRow`&&(n=!0);t+=1}return r}function fp(){return{flow:{null:{name:`table`,tokenize:pp,resolveAll:mp}}}}function pp(e,t,n){let r=this,i=0,a=0,o;return s;function s(e){let t=r.events.length-1;for(;t>-1;){let{type:e}=r.events[t][1];if(e===`lineEnding`||e===`linePrefix`)t--;else break}let i=t>-1?r.events[t][1].type:null,a=i===`tableHead`||i===`tableRow`?S:c;return a===S&&r.parser.lazy[r.now().line]?n(e):a(e)}function c(t){return e.enter(`tableHead`),e.enter(`tableRow`),l(t)}function l(e){return e===124?u(e):(o=!0,a+=1,u(e))}function u(t){return t===null?n(t):z(t)?a>1?(a=0,r.interrupt=!0,e.exit(`tableRow`),e.enter(`lineEnding`),e.consume(t),e.exit(`lineEnding`),p):n(t):V(t)?H(e,u,`whitespace`)(t):(a+=1,o&&(o=!1,i+=1),t===124?(e.enter(`tableCellDivider`),e.consume(t),e.exit(`tableCellDivider`),o=!0,u):(e.enter(`data`),d(t)))}function d(t){return t===null||t===124||B(t)?(e.exit(`data`),u(t)):(e.consume(t),t===92?f:d)}function f(t){return t===92||t===124?(e.consume(t),d):d(t)}function p(t){return r.interrupt=!1,r.parser.lazy[r.now().line]?n(t):(e.enter(`tableDelimiterRow`),o=!1,V(t)?H(e,m,`linePrefix`,r.parser.constructs.disable.null.includes(`codeIndented`)?void 0:4)(t):m(t))}function m(t){return t===45||t===58?g(t):t===124?(o=!0,e.enter(`tableCellDivider`),e.consume(t),e.exit(`tableCellDivider`),h):x(t)}function h(t){return V(t)?H(e,g,`whitespace`)(t):g(t)}function g(t){return t===58?(a+=1,o=!0,e.enter(`tableDelimiterMarker`),e.consume(t),e.exit(`tableDelimiterMarker`),_):t===45?(a+=1,_(t)):t===null||z(t)?b(t):x(t)}function _(t){return t===45?(e.enter(`tableDelimiterFiller`),v(t)):x(t)}function v(t){return t===45?(e.consume(t),v):t===58?(o=!0,e.exit(`tableDelimiterFiller`),e.enter(`tableDelimiterMarker`),e.consume(t),e.exit(`tableDelimiterMarker`),y):(e.exit(`tableDelimiterFiller`),y(t))}function y(t){return V(t)?H(e,b,`whitespace`)(t):b(t)}function b(n){return n===124?m(n):n===null||z(n)?!o||i!==a?x(n):(e.exit(`tableDelimiterRow`),e.exit(`tableHead`),t(n)):x(n)}function x(e){return n(e)}function S(t){return e.enter(`tableRow`),C(t)}function C(n){return n===124?(e.enter(`tableCellDivider`),e.consume(n),e.exit(`tableCellDivider`),C):n===null||z(n)?(e.exit(`tableRow`),t(n)):V(n)?H(e,C,`whitespace`)(n):(e.enter(`data`),ee(n))}function ee(t){return t===null||t===124||B(t)?(e.exit(`data`),C(t)):(e.consume(t),t===92?w:ee)}function w(t){return t===92||t===124?(e.consume(t),ee):ee(t)}}function mp(e,t){let n=-1,r=!0,i=0,a=[0,0,0,0],o=[0,0,0,0],s=!1,c=0,l,u,d,f=new lp;for(;++n<e.length;){let p=e[n],m=p[1];p[0]===`enter`?m.type===`tableHead`?(s=!1,c!==0&&(gp(f,t,c,l,u),u=void 0,c=0),l={type:`table`,start:Object.assign({},m.start),end:Object.assign({},m.end)},f.add(n,0,[[`enter`,l,t]])):m.type===`tableRow`||m.type===`tableDelimiterRow`?(r=!0,d=void 0,a=[0,0,0,0],o=[0,n+1,0,0],s&&(s=!1,u={type:`tableBody`,start:Object.assign({},m.start),end:Object.assign({},m.end)},f.add(n,0,[[`enter`,u,t]])),i=m.type===`tableDelimiterRow`?2:u?3:1):i&&(m.type===`data`||m.type===`tableDelimiterMarker`||m.type===`tableDelimiterFiller`)?(r=!1,o[2]===0&&(a[1]!==0&&(o[0]=o[1],d=hp(f,t,a,i,void 0,d),a=[0,0,0,0]),o[2]=n)):m.type===`tableCellDivider`&&(r?r=!1:(a[1]!==0&&(o[0]=o[1],d=hp(f,t,a,i,void 0,d)),a=o,o=[a[1],n,0,0])):m.type===`tableHead`?(s=!0,c=n):m.type===`tableRow`||m.type===`tableDelimiterRow`?(c=n,a[1]===0?o[1]!==0&&(d=hp(f,t,o,i,n,d)):(o[0]=o[1],d=hp(f,t,a,i,n,d)),i=0):i&&(m.type===`data`||m.type===`tableDelimiterMarker`||m.type===`tableDelimiterFiller`)&&(o[3]=n)}for(c!==0&&gp(f,t,c,l,u),f.consume(t.events),n=-1;++n<t.events.length;){let e=t.events[n];e[0]===`enter`&&e[1].type===`table`&&(e[1]._align=dp(t.events,n))}return e}function hp(e,t,n,r,i,a){let o=r===1?`tableHeader`:r===2?`tableDelimiter`:`tableData`;n[0]!==0&&(a.end=Object.assign({},_p(t.events,n[0])),e.add(n[0],0,[[`exit`,a,t]]));let s=_p(t.events,n[1]);if(a={type:o,start:Object.assign({},s),end:Object.assign({},s)},e.add(n[1],0,[[`enter`,a,t]]),n[2]!==0){let i=_p(t.events,n[2]),a=_p(t.events,n[3]),o={type:`tableContent`,start:Object.assign({},i),end:Object.assign({},a)};if(e.add(n[2],0,[[`enter`,o,t]]),r!==2){let r=t.events[n[2]],i=t.events[n[3]];if(r[1].end=Object.assign({},i[1].end),r[1].type=`chunkText`,r[1].contentType=`text`,n[3]>n[2]+1){let t=n[2]+1,r=n[3]-n[2]-1;e.add(t,r,[])}}e.add(n[3]+1,0,[[`exit`,o,t]])}return i!==void 0&&(a.end=Object.assign({},_p(t.events,i)),e.add(i,0,[[`exit`,a,t]]),a=void 0),a}function gp(e,t,n,r,i){let a=[],o=_p(t.events,n);i&&(i.end=Object.assign({},o),a.push([`exit`,i,t])),r.end=Object.assign({},o),a.push([`exit`,r,t]),e.add(n+1,0,a)}function _p(e,t){let n=e[t],r=n[0]===`enter`?`start`:`end`;return n[1][r]}var vp={name:`tasklistCheck`,tokenize:bp};function yp(){return{text:{91:vp}}}function bp(e,t,n){let r=this;return i;function i(t){return r.previous!==null||!r._gfmTasklistFirstContentOfListItem?n(t):(e.enter(`taskListCheck`),e.enter(`taskListCheckMarker`),e.consume(t),e.exit(`taskListCheckMarker`),a)}function a(t){return B(t)?(e.enter(`taskListCheckValueUnchecked`),e.consume(t),e.exit(`taskListCheckValueUnchecked`),o):t===88||t===120?(e.enter(`taskListCheckValueChecked`),e.consume(t),e.exit(`taskListCheckValueChecked`),o):n(t)}function o(t){return t===93?(e.enter(`taskListCheckMarker`),e.consume(t),e.exit(`taskListCheckMarker`),e.exit(`taskListCheck`),s):n(t)}function s(r){return z(r)?t(r):V(r)?e.check({tokenize:xp},t,n)(r):n(r)}}function xp(e,t,n){return H(e,r,`whitespace`);function r(e){return e===null?n(e):t(e)}}function Sp(e){return La([Bf(),$(),cp(e),fp(),yp()])}var Cp={};function wp(e){let t=this,n=e||Cp,r=t.data(),i=r.micromarkExtensions||=[],a=r.fromMarkdownExtensions||=[],o=r.toMarkdownExtensions||=[];i.push(Sp(n)),a.push(kf()),o.push(Af(n))}var Tp=class extends S.Component{state={hasError:!1};static getDerivedStateFromError(){return{hasError:!0}}render(){return this.state.hasError?(0,N.jsx)(`p`,{role:`alert`,children:`This document couldn't be displayed.`}):this.props.children}};function Ep({content:e}){return(0,N.jsx)(Tp,{children:(0,N.jsx)(`div`,{className:`docs-markdown`,children:(0,N.jsx)(Du,{remarkPlugins:[wp],children:e})})})}function Dp(){let{id:e}=St(),t=Xr.find(t=>t.id===e);return t===void 0?(0,N.jsxs)(`div`,{children:[(0,N.jsx)(`p`,{children:`This post couldn't be found.`}),(0,N.jsx)(jn,{to:`/blog`,children:`Back to blog`})]}):(0,N.jsxs)(`div`,{children:[(0,N.jsx)(`p`,{className:`docs-entry-meta`,children:t.date}),(0,N.jsx)(Ep,{content:t.content})]})}function Op(){let{id:e}=St(),t=Yr.find(t=>t.id===e);return t===void 0?(0,N.jsxs)(`div`,{children:[(0,N.jsx)(`p`,{children:`This document couldn't be found.`}),(0,N.jsx)(jn,{to:`/docs`,children:`Back to documentation`})]}):(0,N.jsx)(Ep,{content:t.content})}var kp={spec:`Specifications`,product:`Product`,architecture:`Architecture`},Ap={shipped:`Shipped`,"in-progress":`In Progress`,planned:`Planned`};function jp({status:e}){return(0,N.jsx)(`span`,{className:`docs-badge docs-badge-${e}`,children:Ap[e]})}function Mp(){return(0,N.jsxs)(`div`,{children:[(0,N.jsx)(`h1`,{children:`Documentation`}),(0,N.jsx)(`p`,{children:`Every specification and reference document behind this product, shipped and planned.`}),[`spec`,`product`,`architecture`].map(e=>{let t=Yr.filter(t=>t.category===e);return t.length===0?null:(0,N.jsxs)(`div`,{children:[(0,N.jsx)(`h2`,{className:`docs-category-heading`,children:kp[e]}),(0,N.jsx)(`ul`,{className:`docs-entry-list`,children:t.map(e=>(0,N.jsxs)(`li`,{children:[(0,N.jsx)(jn,{to:`/docs/${e.id}`,children:e.title}),e.status!==void 0&&(0,N.jsx)(`div`,{className:`docs-entry-meta`,children:(0,N.jsx)(jp,{status:e.status})})]},e.id))})]},e)})]})}function Np({children:e}){return(0,N.jsxs)(`div`,{className:`docs-theme`,children:[(0,N.jsxs)(`nav`,{className:`docs-nav`,"aria-label":`Documentation navigation`,children:[(0,N.jsx)(jn,{to:`/docs`,children:`Documentation`}),(0,N.jsx)(jn,{to:`/blog`,children:`Blog`}),(0,N.jsx)(jn,{to:`/`,className:`docs-nav-back`,children:`Back to practice app`})]}),(0,N.jsx)(`main`,{className:`docs-main`,children:e}),(0,N.jsx)(Wn,{})]})}function Pp({mastery:e}){let t=e?.percentage??0,n=Math.round(t);return(0,N.jsxs)(`div`,{className:`card`,children:[(0,N.jsxs)(`p`,{className:`mastery-text`,children:[(0,N.jsx)(`span`,{"aria-hidden":`true`,children:`⭐`}),` Mental addition mastery: `,(0,N.jsxs)(`strong`,{children:[n,`%`]})]}),(0,N.jsx)(`span`,{className:`progress-track`,"aria-hidden":`true`,children:(0,N.jsx)(`span`,{className:`progress-fill`,style:{width:`${n}%`}})})]})}var Fp=`learncoreskills.profiles`;function Ip(e){let t=e.getItem(Fp);return t?JSON.parse(t):{children:[],activeChildId:null}}function Lp(e,t){e.setItem(Fp,JSON.stringify(t))}function Rp(e,t){if(t.trim().length===0)throw Error(`alias is required`);let n=Ip(e),r={id:crypto.randomUUID(),alias:t,createdAt:Date.now(),currentGrade:null};return Lp(e,{children:[...n.children,r],activeChildId:n.activeChildId??r.id}),r}function zp(e,t){let n=Ip(e),r=n.children.findIndex(e=>e.id===t.id);Lp(e,{children:r===-1?[...n.children,t]:n.children.map((e,n)=>n===r?t:e),activeChildId:n.activeChildId??t.id})}function Bp(e){return Ip(e).children}function Vp(e){return Ip(e).activeChildId}function Hp(e,t){let n=Ip(e);if(!n.children.some(e=>e.id===t))throw Error(`no such child profile: ${t}`);Lp(e,{...n,activeChildId:t})}function Up(e,t,n){let r=Ip(e),i=r.children.findIndex(e=>e.id===t);if(i===-1)throw Error(`no such child profile: ${t}`);let a=r.children.map((e,t)=>t===i?{...e,currentGrade:n}:e);Lp(e,{...r,children:a})}function Wp(e,t){return`learncoreskills.child.${e}.${t}`}function Gp(){let[e,t]=(0,S.useState)(()=>Bp(window.localStorage)),[n,r]=(0,S.useState)(()=>Vp(window.localStorage));function i(){t(Bp(window.localStorage)),r(Vp(window.localStorage))}function a(e){Rp(window.localStorage,e),i()}function o(e){Hp(window.localStorage,e),r(Vp(window.localStorage))}return{children:e,activeChildId:n,createProfile:a,switchProfile:o,refresh:i}}var Kp={id:`math.addition.mental`,nameKey:`competency.math.addition.mental.name`,descriptionKey:`competency.math.addition.mental.description`,subjectId:`mathematics`,level:1,tierCount:5,prerequisiteIds:[]},qp=[Kp],Jp=[{areaKey:`number-sense`,nameKey:`curriculum.area.number-sense`,label:`Number sense`},{areaKey:`place-value`,nameKey:`curriculum.area.place-value`,label:`Place value`},{areaKey:`comparing-ordering`,nameKey:`curriculum.area.comparing-ordering`,label:`Comparing & ordering`},{areaKey:`addition`,nameKey:`curriculum.area.addition`,label:`Addition`},{areaKey:`subtraction`,nameKey:`curriculum.area.subtraction`,label:`Subtraction`},{areaKey:`multiplication`,nameKey:`curriculum.area.multiplication`,label:`Multiplication`},{areaKey:`division`,nameKey:`curriculum.area.division`,label:`Division`},{areaKey:`mental-mathematics`,nameKey:`curriculum.area.mental-mathematics`,label:`Mental mathematics`},{areaKey:`fractions`,nameKey:`curriculum.area.fractions`,label:`Fractions`},{areaKey:`decimals`,nameKey:`curriculum.area.decimals`,label:`Decimals`},{areaKey:`percentages`,nameKey:`curriculum.area.percentages`,label:`Percentages`},{areaKey:`measurement`,nameKey:`curriculum.area.measurement`,label:`Measurement`},{areaKey:`money`,nameKey:`curriculum.area.money`,label:`Money`},{areaKey:`time`,nameKey:`curriculum.area.time`,label:`Time`},{areaKey:`geometry`,nameKey:`curriculum.area.geometry`,label:`Geometry`},{areaKey:`data-graphs`,nameKey:`curriculum.area.data-graphs`,label:`Data and graphs`},{areaKey:`mathematical-reasoning`,nameKey:`curriculum.area.mathematical-reasoning`,label:`Mathematical reasoning`},{areaKey:`problem-solving`,nameKey:`curriculum.area.problem-solving`,label:`Problem solving`}];function Yp(e){let[t,n]=e.id.split(`.`);if(t===`math`)return Jp.some(e=>e.areaKey===n)?n:void 0}function Xp(e){return e===null?null:Bp(window.localStorage).find(t=>t.id===e)?.currentGrade??null}function Zp(e){let[t,n]=(0,S.useState)(()=>Xp(e));(0,S.useEffect)(()=>{n(Xp(e))},[e]);function r(t){e!==null&&(Up(window.localStorage,e,t),n(t))}return{currentGrade:t,setGrade:r}}var Qp=5,$p=90;function em(e,t,n){let r=e.filter(e=>e.competencyId===t&&e.tier===n).sort((e,t)=>e.timestamp-t.timestamp).slice(-10),i=r.length;if(i<Qp)return{competencyId:t,tier:n,percentage:`not-started`,attemptsConsidered:i,mastered:!1};let a=r.filter(e=>e.correct).length/i*100;return{competencyId:t,tier:n,percentage:a,attemptsConsidered:i,mastered:a>=$p}}function tm(e,t){let n=Array.from({length:t.tierCount},(n,r)=>em(e,t.id,r+1)),r=n.reduce((e,t)=>e+(t.percentage===`not-started`?0:t.percentage),0);return{competencyId:t.id,percentage:r/n.length,tiers:n}}var nm=`mastery-signals`;function rm(e){let t=window.localStorage.getItem(Wp(e,nm));return t?JSON.parse(t):[]}function im(e,t){let n=[...rm(e),t];window.localStorage.setItem(Wp(e,nm),JSON.stringify(n))}function am(e,t){window.localStorage.setItem(Wp(e,nm),JSON.stringify(t))}function om(e,t=0){return(0,S.useMemo)(()=>{if(e===null)return null;let t=rm(e);return qp.map(e=>tm(t,e))},[e,t])}function sm(e,t,n){return Jp.map(r=>{let i=e.filter(e=>Yp(e)===r.areaKey&&e.level===n);if(i.length===0)return{areaKey:r.areaKey,nameKey:r.nameKey,label:r.label,status:`not-applicable-at-grade`,currentPercentage:null,targetPercentage:100};let a=i.map(e=>tm(t,e).percentage),o=a.reduce((e,t)=>e+t,0)/a.length;return{areaKey:r.areaKey,nameKey:r.nameKey,label:r.label,status:`tracked`,currentPercentage:o,targetPercentage:100}})}var cm=[1,2,3,4,5];function lm({currentGrade:e,onSelect:t}){return(0,N.jsxs)(`div`,{className:`card grade-selector`,"aria-label":`Current grade`,children:[(0,N.jsx)(`p`,{children:e===null?`Set your child's current grade to see their progression chart:`:`Current grade:`}),(0,N.jsx)(`div`,{className:`grade-selector-options`,role:`radiogroup`,"aria-label":`Grade`,children:cm.map(n=>(0,N.jsx)(`button`,{type:`button`,role:`radio`,className:`grade-selector-option`,"aria-checked":e===n,"aria-pressed":e===n,onClick:()=>t(n),children:`G${n}`},n))})]})}var um=460,dm=um/2,fm=130,pm=162;function mm(e,t){return{x:dm+t*Math.cos(e),y:dm+t*Math.sin(e)}}function hm(e,t){return-Math.PI/2+e/t*2*Math.PI}function gm(e){let t=Math.cos(e);return t>.15?`start`:t<-.15?`end`:`middle`}function _m(e){return e.state===`not-applicable-at-grade`?`${e.label}: not yet applicable at this grade`:e.state===`not-tracked-yet`?`${e.label}: not tracked yet`:`${e.label}: ${Math.round(e.current??0)}% (target ${e.target??100}%)`}function vm({axes:e}){if(e.length<3)return(0,N.jsx)(`ul`,{className:`radar-chart-fallback-list`,"aria-label":`Progress by category`,children:e.map(e=>(0,N.jsx)(`li`,{children:_m(e)},e.key))});let t=e.map((e,t)=>({axis:e,index:t})).filter(({axis:e})=>e.state===`tracked`),n=t.map(({axis:t,index:n})=>mm(hm(n,e.length),Math.max(0,Math.min(100,t.current??0))/100*fm)),r=t.map(({axis:t,index:n})=>mm(hm(n,e.length),Math.max(0,Math.min(100,t.target??100))/100*fm)),i=e=>e.map(e=>`${e.x},${e.y}`).join(` `);return(0,N.jsxs)(`div`,{className:`radar-chart`,children:[(0,N.jsxs)(`svg`,{className:`radar-chart-svg`,viewBox:`-110 0 680 ${um}`,width:um,height:um,role:`img`,"aria-label":`Progress by category`,children:[e.map((t,n)=>{let r=hm(n,e.length),i=mm(r,fm),a=mm(r,pm),o=t.state!==`tracked`;return(0,N.jsxs)(`g`,{children:[(0,N.jsx)(`line`,{x1:dm,y1:dm,x2:i.x,y2:i.y,className:o?`radar-chart-spoke-muted`:`radar-chart-spoke`,strokeWidth:1}),(0,N.jsx)(`text`,{x:a.x,y:a.y,fontSize:11,textAnchor:gm(r),className:o?`radar-chart-label-muted`:`radar-chart-label`,children:t.label})]},t.key)}),r.length>=3&&(0,N.jsx)(`polygon`,{points:i(r),className:`radar-chart-target-shape`,fill:`none`,strokeWidth:1.5}),n.length>=3&&(0,N.jsx)(`polygon`,{points:i(n),className:`radar-chart-current-shape`,strokeWidth:2}),n.map((e,n)=>(0,N.jsx)(`circle`,{cx:e.x,cy:e.y,r:3,className:`radar-chart-current-point`},`current-${t[n].axis.key}`))]}),(0,N.jsx)(`ul`,{className:`radar-chart-accessible-list`,children:e.map(e=>(0,N.jsx)(`li`,{children:_m(e)},e.key))})]})}function ym({progress:e}){let t=e.map(e=>({key:e.areaKey,label:e.label,current:e.currentPercentage,target:e.status===`tracked`?e.targetPercentage:null,state:e.status}));return(0,N.jsxs)(`div`,{children:[(0,N.jsx)(`h3`,{children:`Mathematics`}),(0,N.jsx)(vm,{axes:t})]})}var bm=[{domainKey:`language-literacy`,nameKey:`skillsFramework.domain.language-literacy`,label:`Language`},{domainKey:`mathematics`,nameKey:`skillsFramework.domain.mathematics`,label:`Mathematics`},{domainKey:`science`,nameKey:`skillsFramework.domain.science`,label:`Science`},{domainKey:`geography`,nameKey:`skillsFramework.domain.geography`,label:`Geography`},{domainKey:`history`,nameKey:`skillsFramework.domain.history`,label:`History`},{domainKey:`civics-ethics`,nameKey:`skillsFramework.domain.civics-ethics`,label:`Civics & Ethics`},{domainKey:`money-financial-literacy`,nameKey:`skillsFramework.domain.money-financial-literacy`,label:`Money`},{domainKey:`digital-literacy`,nameKey:`skillsFramework.domain.digital-literacy`,label:`Digital Literacy`},{domainKey:`physical-skills-sport`,nameKey:`skillsFramework.domain.physical-skills-sport`,label:`Physical Skills`},{domainKey:`health-safety-first-aid`,nameKey:`skillsFramework.domain.health-safety-first-aid`,label:`Health & Safety`},{domainKey:`music`,nameKey:`skillsFramework.domain.music`,label:`Music`},{domainKey:`visual-arts`,nameKey:`skillsFramework.domain.visual-arts`,label:`Visual Arts`},{domainKey:`dance-drama-performance`,nameKey:`skillsFramework.domain.dance-drama-performance`,label:`Dance & Drama`},{domainKey:`practical-life`,nameKey:`skillsFramework.domain.practical-life`,label:`Practical Life`},{domainKey:`outdoors-nature`,nameKey:`skillsFramework.domain.outdoors-nature`,label:`Outdoors & Nature`},{domainKey:`social-emotional`,nameKey:`skillsFramework.domain.social-emotional`,label:`Social & Emotional`},{domainKey:`learning-how-to-learn`,nameKey:`skillsFramework.domain.learning-how-to-learn`,label:`Learning Skills`},{domainKey:`second-language`,nameKey:`skillsFramework.domain.second-language`,label:`2nd Language`},{domainKey:`games-logic-strategy`,nameKey:`skillsFramework.domain.games-logic-strategy`,label:`Games & Logic`},{domainKey:`general-knowledge`,nameKey:`skillsFramework.domain.general-knowledge`,label:`General Knowledge`}];function xm(e){let t=e.filter(e=>e.status===`tracked`&&e.currentPercentage!==null),n=t.length===0?0:t.reduce((e,t)=>e+(t.currentPercentage??0),0)/t.length;return bm.map(e=>e.domainKey===`mathematics`?{domainKey:e.domainKey,nameKey:e.nameKey,label:e.label,status:`tracked`,currentPercentage:n,targetPercentage:100}:{domainKey:e.domainKey,nameKey:e.nameKey,label:e.label,status:`not-tracked-yet`,currentPercentage:null,targetPercentage:null})}function Sm({mathematicsAreaProgress:e}){let t=(0,S.useMemo)(()=>xm(e),[e]).map(e=>({key:e.domainKey,label:e.label,current:e.currentPercentage,target:e.targetPercentage,state:e.status}));return(0,N.jsxs)(`div`,{children:[(0,N.jsx)(`h3`,{children:`Whole-child skill map`}),(0,N.jsx)(`p`,{children:`An illustrative map of the full primary-skills framework. Only mathematics is tracked today — every other area will show real progress once the app supports it.`}),(0,N.jsx)(vm,{axes:t})]})}function Cm({childId:e}){let t=om(e)?.find(e=>e.competencyId===Kp.id)??null,{currentGrade:n,setGrade:r}=Zp(e),i=(0,S.useMemo)(()=>n===null?null:sm(qp,rm(e),n),[e,n]);return t===null||t.tiers.every(e=>e.percentage===`not-started`)?(0,N.jsxs)(`div`,{className:`card`,children:[(0,N.jsx)(`h2`,{children:`Advancement Report`}),(0,N.jsx)(`p`,{children:`No progress yet — mastery will show up here once practice sessions are completed.`})]}):(0,N.jsxs)(`div`,{className:`card`,children:[(0,N.jsx)(`h2`,{children:`Advancement Report`}),(0,N.jsxs)(`p`,{children:[`Mental addition mastery: `,(0,N.jsxs)(`strong`,{children:[Math.round(t.percentage),`%`]})]}),(0,N.jsx)(lm,{currentGrade:n,onSelect:r}),i!==null&&(0,N.jsxs)(N.Fragment,{children:[(0,N.jsx)(ym,{progress:i}),(0,N.jsx)(Sm,{mathematicsAreaProgress:i})]})]})}var wm=[{fromVersion:1,migrate(e){let t=e;return{...t,profile:{...t.profile,currentGrade:null}}}}];function Tm(e,t){return{schemaVersion:2,exportedAt:Date.now(),profile:{id:e.id,alias:e.alias,createdAt:e.createdAt,currentGrade:e.currentGrade??null},masterySignals:t}}function Em(e){return typeof e==`number`&&Number.isInteger(e)&&e>0}function Dm(e){return e===null||typeof e==`number`&&Number.isInteger(e)&&e>=1&&e<=5}function Om(e){if(typeof e!=`object`||!e)return!1;let t=e,n=t.profile;if(typeof n!=`object`||!n)return!1;let r=n;return typeof r.id!=`string`||r.id.length===0||typeof r.alias!=`string`||typeof r.createdAt!=`number`||!Dm(r.currentGrade)?!1:Array.isArray(t.masterySignals)}function km(e){if(typeof e!=`object`||!e)return{ok:!1,reason:`invalid-shape`};let t=e.schemaVersion;if(!Em(t))return{ok:!1,reason:`invalid-shape`};if(t>2)return{ok:!1,reason:`unsupported-newer-version`};if(t<1)return{ok:!1,reason:`unsupported-older-version`};let n=e,r=t;for(;r<2;){let e=wm.find(e=>e.fromVersion===r);if(!e)return{ok:!1,reason:`unsupported-older-version`};n=e.migrate(n),r+=1}return Om(n)?{ok:!0,data:{profile:{id:n.profile.id,alias:n.profile.alias,createdAt:n.profile.createdAt,currentGrade:n.profile.currentGrade},masterySignals:n.masterySignals}}:{ok:!1,reason:`invalid-shape`}}function Am(e){let t=Bp(window.localStorage).find(t=>t.id===e);if(!t)throw Error(`no such child profile: ${e}`);let n=Tm(t,rm(e)),r=new Blob([JSON.stringify(n,null,2)],{type:`application/json`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=`${t.alias.trim()||`child`}-export.json`,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(i)}function jm({childId:e}){return(0,N.jsx)(`button`,{type:`button`,disabled:e===null,onClick:()=>e!==null&&Am(e),children:`Export this child's data`})}function Mm(e){return new Promise((t,n)=>{let r=new FileReader;r.onload=()=>t(r.result),r.onerror=()=>n(r.error),r.readAsText(e)})}async function Nm(e){let t;try{t=await Mm(e)}catch{return{status:`error`,reason:`unreadable`}}let n;try{n=JSON.parse(t)}catch{return{status:`error`,reason:`unreadable`}}let r=km(n);return r.ok?Bp(window.localStorage).some(e=>e.id===r.data.profile.id)?{status:`conflict`,parsed:r.data}:(zp(window.localStorage,r.data.profile),am(r.data.profile.id,r.data.masterySignals),{status:`imported`,childId:r.data.profile.id}):{status:`error`,reason:r.reason}}function Pm(e){let t=crypto.randomUUID();return zp(window.localStorage,{...e.profile,id:t}),am(t,e.masterySignals),t}function Fm(e){return zp(window.localStorage,e.profile),am(e.profile.id,e.masterySignals),e.profile.id}function Im({parsed:e,onResolved:t,onCancel:n}){return(0,N.jsxs)(`div`,{role:`dialog`,"aria-label":`Resolve import conflict`,children:[(0,N.jsxs)(`p`,{children:[`A profile matching "`,e.profile.alias,`" already exists on this device. How should this import be applied?`]}),(0,N.jsx)(`button`,{type:`button`,onClick:()=>t(Pm(e)),children:`Import as a new profile`}),(0,N.jsx)(`button`,{type:`button`,onClick:()=>t(Fm(e)),children:`Replace this profile's data`}),(0,N.jsx)(`button`,{type:`button`,onClick:n,children:`Cancel`})]})}function Lm(e){switch(e){case`unreadable`:return`That file couldn't be read. Make sure you selected a valid export file.`;case`invalid-shape`:return`That file isn't a valid child export.`;case`unsupported-newer-version`:return`That file was exported by a newer version of the app. Update the app to import it.`;case`unsupported-older-version`:return`That file is from a version of the app that's no longer supported for import.`}}function Rm({onImported:e}){let t=(0,S.useRef)(null),[n,r]=(0,S.useState)(null),[i,a]=(0,S.useState)(null);async function o(t){let n=t.target.files?.[0];if(t.target.value=``,!n)return;a(null);let i=await Nm(n);i.status===`imported`?e():i.status===`conflict`?r(i.parsed):a(Lm(i.reason))}return(0,N.jsxs)(`div`,{children:[(0,N.jsx)(`button`,{type:`button`,onClick:()=>t.current?.click(),children:`Import a child's data`}),(0,N.jsx)(`input`,{ref:t,type:`file`,accept:`application/json`,hidden:!0,"aria-label":`Import a child export file`,onChange:e=>{o(e)}}),i!==null&&(0,N.jsx)(`p`,{role:`alert`,children:i}),n!==null&&(0,N.jsx)(Im,{parsed:n,onResolved:()=>{r(null),e()},onCancel:()=>r(null)})]})}function zm(){let{activeChildId:e,refresh:t}=Gp();return(0,N.jsxs)(`div`,{className:`docs-theme`,children:[(0,N.jsxs)(`nav`,{className:`docs-nav`,"aria-label":`Parent area navigation`,children:[(0,N.jsx)(`span`,{children:`Parent Area`}),(0,N.jsx)(jn,{to:`/`,className:`docs-nav-back`,children:`Back to practice app`})]}),(0,N.jsx)(`main`,{className:`docs-main`,children:e===null?(0,N.jsxs)(`div`,{children:[(0,N.jsxs)(`p`,{children:[`No active child profile yet. `,(0,N.jsx)(jn,{to:`/`,children:`Create a child profile first`}),`, or import a previously exported child below.`]}),(0,N.jsx)(Rm,{onImported:t})]}):(0,N.jsxs)(`section`,{"aria-label":`Active child`,children:[(0,N.jsx)(Cm,{childId:e}),(0,N.jsx)(jm,{childId:e}),(0,N.jsx)(Rm,{onImported:t})]})}),(0,N.jsx)(Wn,{})]})}function Bm(e){let t=e>>>0;return function(){t=t+1831565813>>>0;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}function Vm(e,t,n){return t+Math.floor(e()*(n-t+1))}function Hm(e){return Number.isInteger(e)&&e>=1&&e<=5}function Um(e){let t=Vm(e,0,9);return{operandA:t,operandB:Vm(e,0,9-t)}}function Wm(e){let t=Vm(e,1,9);return{operandA:t,operandB:Vm(e,Math.max(1,10-t),9)}}function Gm(e){let t=Vm(e,0,9),n=Vm(e,0,9-t);return{operandA:Vm(e,1,9)*10+n,operandB:t}}function Km(e){let t=Vm(e,1,9);return{onesA:Vm(e,Math.max(0,10-t),9),onesB:t}}function qm(e){let{onesA:t,onesB:n}=Km(e),r=Vm(e,1,9),i=Vm(e,1,9);return{operandA:r*10+t,operandB:i*10+n}}function Jm(e){let{onesA:t,onesB:n}=Km(e),r=Vm(e,0,9),i=Vm(e,1,9)*100+r*10+t,a=e()<.5,o=Vm(e,+!a,9);return{operandA:i,operandB:(a?Vm(e,1,9):0)*100+o*10+n}}function Ym(e,t){if(!Hm(e))throw Error(`invalid tier: ${e} (must be an integer in 1..5)`);let n=Bm(t),{operandA:r,operandB:i}=e===1?Um(n):e===2?Wm(n):e===3?Gm(n):e===4?qm(n):Jm(n);return{id:`mental-addition-${e}-${t}`,tier:e,operandA:r,operandB:i,correctSum:r+i}}var Xm=`math.addition.mental`;function Zm(e,t,n,r){return{competencyId:Xm,tier:e.tier,correct:t,timeMs:n,timestamp:r,questionId:e.id}}function Qm(e,t){let n=Bm(t),r=[];for(let t=0;t<10;t++){let t=Math.floor(n()*4294967295);r.push(Ym(e,t))}return{tier:e,questions:r}}var $m={id:`mental-addition`,competencyIds:[Xm],generateQuestion(e,t){return Ym(e,t)},validateAnswer(e,t){return{correct:t===e.correctSum}}};function eh(e,t){let n=[],r=new Set(t.map(e=>e.id)),i=new Set;for(let t of e)i.has(t.id)&&n.push({kind:`duplicate-plugin-id`,id:t.id}),i.add(t.id);for(let t of e)for(let e of t.competencyIds)r.has(e)||n.push({kind:`unknown-competency-reference`,pluginId:t.id,competencyId:e});return{valid:n.length===0,errors:n}}function th(e){switch(e.kind){case`duplicate-plugin-id`:return`duplicate plugin id: "${e.id}"`;case`unknown-competency-reference`:return`plugin "${e.pluginId}" references unknown competency id: "${e.competencyId}"`}}function nh(e,t){let n=eh(e,t);if(!n.valid){let e=n.errors.map(th).join(`; `);throw Error(`Invalid plugin registry: ${e}`)}let r=new Map(e.map(e=>[e.id,e]));return{getPlugin(e){return r.get(e)},getPluginsForCompetency(t){return e.filter(e=>e.competencyIds.includes(t))},all(){return[...e]}}}var rh=nh([$m],[Kp]),ih=10,ah=1200;function oh({childId:e,tier:t,onComplete:n,feedbackDelayMs:r=ah}){let[i]=(0,S.useState)(()=>Qm(t,Date.now())),[a,o]=(0,S.useState)(0),[s,c]=(0,S.useState)(``),[l,u]=(0,S.useState)(null),[d,f]=(0,S.useState)(()=>Date.now()),p=i.questions[a],m=rh.getPlugin(`mental-addition`);if(!p||!m)return null;function h(t){if(t.preventDefault(),l!==null||!p||!m)return;let i=Number(s),{correct:h}=m.validateAnswer(p,i),g=Date.now()-d;im(e,Zm(p,h,g,Date.now())),u({correct:h,correctSum:p.correctSum}),setTimeout(()=>{u(null),c(``),a+1>=ih?n():(o(e=>e+1),f(Date.now()))},r)}let g=a/ih*100;return(0,N.jsxs)(`div`,{className:`card`,children:[(0,N.jsx)(`div`,{className:`session-progress`,children:(0,N.jsxs)(`p`,{children:[`Question `,a+1,` of `,ih]})}),(0,N.jsx)(`div`,{className:`progress-track`,"aria-hidden":`true`,children:(0,N.jsx)(`span`,{className:`progress-fill`,style:{width:`${g}%`}})}),(0,N.jsx)(`div`,{className:`equation-card`,children:(0,N.jsxs)(`p`,{children:[p.operandA,` + `,p.operandB,` = ?`]})}),(0,N.jsxs)(`form`,{onSubmit:h,className:`answer-form`,children:[(0,N.jsx)(`input`,{type:`number`,"aria-label":`answer`,className:`text-input answer-input`,value:s,onChange:e=>c(e.target.value),disabled:l!==null}),(0,N.jsxs)(`button`,{type:`submit`,className:`btn`,disabled:l!==null,children:[(0,N.jsx)(`span`,{"aria-hidden":`true`,children:`✅ `}),`Submit`]})]}),l!==null&&(l.correct?(0,N.jsxs)(`p`,{role:`status`,className:`feedback-banner feedback-correct`,children:[(0,N.jsx)(`span`,{"aria-hidden":`true`,children:`🎉 `}),`Correct!`]}):(0,N.jsxs)(`p`,{role:`status`,className:`feedback-banner feedback-incorrect`,children:[(0,N.jsx)(`span`,{"aria-hidden":`true`,children:`💛 `}),`Not quite — the answer was `,l.correctSum,`.`]}))]})}var sh=[`🐵`,`🐸`,`🦊`,`🐼`,`🐯`,`🐨`,`🐰`,`🦁`,`🐷`,`🐙`],ch=[`#ff8a3d`,`#3fa9f5`,`#3ecf6e`,`#ff6f9c`,`#7c4dff`,`#00c2a8`,`#ffc93c`];function lh(e,t){let n=0;for(let t of e)n=(n*31+t.charCodeAt(0))%997;return t[n%t.length]}function uh({profiles:e,activeChildId:t,onCreate:n,onSwitch:r}){let[i,a]=(0,S.useState)(``);function o(e){e.preventDefault(),i.trim().length!==0&&(n(i),a(``))}return(0,N.jsxs)(`div`,{className:`card`,children:[(0,N.jsxs)(`h2`,{className:`card-title`,children:[(0,N.jsx)(`span`,{"aria-hidden":`true`,children:e.length===0?`👋`:`🧒`}),e.length===0?`Add your first child`:`Children`]}),(0,N.jsxs)(`form`,{onSubmit:o,className:`form-row`,children:[(0,N.jsxs)(`div`,{className:`field`,children:[(0,N.jsx)(`label`,{htmlFor:`alias-input`,className:`field-label`,children:`Child's name`}),(0,N.jsx)(`input`,{id:`alias-input`,type:`text`,className:`text-input`,value:i,onChange:e=>a(e.target.value)})]}),(0,N.jsxs)(`button`,{type:`submit`,className:`btn`,children:[(0,N.jsx)(`span`,{"aria-hidden":`true`,children:`➕ `}),`Add child`]})]}),e.length>0&&(0,N.jsx)(`ul`,{className:`profile-list`,children:e.map(e=>{let n=e.id===t;return(0,N.jsxs)(`li`,{className:`profile-chip${n?` is-active`:``}`,children:[(0,N.jsx)(`span`,{className:`avatar-circle`,style:{background:lh(e.id,ch)},"aria-hidden":`true`,children:lh(e.id,sh)}),(0,N.jsx)(`span`,{className:`profile-name`,children:e.alias}),n?(0,N.jsxs)(`span`,{className:`active-badge`,children:[(0,N.jsx)(`span`,{"aria-hidden":`true`,children:`⭐`}),` (active)`]}):(0,N.jsxs)(`button`,{type:`button`,className:`btn btn-ghost`,onClick:()=>r(e.id),children:[`Switch to `,e.alias]})]},e.id)})})]})}function dh({onStart:e}){let[t,n]=(0,S.useState)(1),r=Array.from({length:Kp.tierCount},(e,t)=>t+1);return(0,N.jsxs)(`div`,{className:`card`,children:[(0,N.jsxs)(`h2`,{className:`card-title`,children:[(0,N.jsx)(`span`,{"aria-hidden":`true`,children:`➕`}),`Mental addition`]}),(0,N.jsxs)(`div`,{className:`field`,children:[(0,N.jsx)(`label`,{htmlFor:`tier-select`,className:`field-label`,children:`Tier`}),(0,N.jsx)(`select`,{id:`tier-select`,className:`select-input`,value:t,onChange:e=>n(Number(e.target.value)),children:r.map(e=>(0,N.jsxs)(`option`,{value:e,children:[`Tier `,e]},e))})]}),(0,N.jsxs)(`button`,{type:`button`,className:`btn btn-teal btn-lg`,onClick:()=>e(t),children:[(0,N.jsx)(`span`,{"aria-hidden":`true`,children:`🚀 `}),`Start session`]})]})}function fh(){let{children:e,activeChildId:t,createProfile:n,switchProfile:r}=Gp(),[i,a]=(0,S.useState)({name:`home`}),[o,s]=(0,S.useState)(0),c=om(t,o)?.find(e=>e.competencyId===Kp.id)??null;function l(e){r(e),a({name:`home`})}return(0,N.jsxs)(`main`,{className:`app-shell`,children:[(0,N.jsxs)(`header`,{className:`app-header`,children:[(0,N.jsx)(`span`,{className:`app-mascot`,"aria-hidden":`true`,children:`🦉`}),(0,N.jsx)(`h1`,{className:`app-title`,children:`Learn Core Skills`}),(0,N.jsxs)(`nav`,{className:`app-header-links`,"aria-label":`Parent and teacher links`,children:[(0,N.jsx)(jn,{to:`/docs`,className:`app-docs-link`,children:`Documentation`}),(0,N.jsx)(jn,{to:`/parent`,className:`app-docs-link`,children:`Parent Area`})]})]}),(0,N.jsx)(uh,{profiles:e,activeChildId:t,onCreate:n,onSwitch:l}),t!==null&&(0,N.jsxs)(`section`,{children:[(0,N.jsx)(Pp,{mastery:c}),i.name===`home`&&(0,N.jsx)(dh,{onStart:e=>a({name:`session`,tier:e})}),i.name===`session`&&(0,N.jsx)(oh,{childId:t,tier:i.tier,onComplete:()=>{s(e=>e+1),a({name:`home`})}},`${t}-${i.tier}`)]}),(0,N.jsx)(Wn,{})]})}function ph(){return(0,N.jsx)(An,{children:(0,N.jsxs)(Kt,{children:[(0,N.jsx)(Wt,{path:`/`,element:(0,N.jsx)(fh,{})}),(0,N.jsx)(Wt,{path:`/docs`,element:(0,N.jsx)(Np,{children:(0,N.jsx)(Mp,{})})}),(0,N.jsx)(Wt,{path:`/docs/:id`,element:(0,N.jsx)(Np,{children:(0,N.jsx)(Op,{})})}),(0,N.jsx)(Wt,{path:`/blog`,element:(0,N.jsx)(Np,{children:(0,N.jsx)(Qr,{})})}),(0,N.jsx)(Wt,{path:`/blog/:id`,element:(0,N.jsx)(Np,{children:(0,N.jsx)(Dp,{})})}),(0,N.jsx)(Wt,{path:`/parent`,element:(0,N.jsx)(zm,{})})]})})}var mh=document.getElementById(`root`);if(!mh)throw Error(`#root element not found`);(0,Hn.createRoot)(mh).render((0,N.jsx)(S.StrictMode,{children:(0,N.jsx)(ph,{})}));